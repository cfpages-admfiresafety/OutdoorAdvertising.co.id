---
article_id: OAD-04-A01
title: "Hierarki Pesan untuk Media Luar Ruang"
slug: "hierarki-pesan-media-luar-ruang"
description: "Prioritize identity, primary message, proof, and action across viewing conditions"
status: outline
publication_date: "2025-11-04"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: OAD-04
primary_intent: "Structure the message"
reader_community: "Outdooradvertising.co.id"
reader_address: "Teman Outdooradvertising.co.id"
final_route: "/artikel/hierarki-pesan-media-luar-ruang.html"
...
# Hierarki Pesan untuk Media Luar Ruang

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Hierarki Pesan untuk Media Luar Ruang”
- **Reader and situation:** Brand with too much copy
- **Reader outcome:** Prioritize identity, primary message, proof, and action across viewing conditions
- **Primary intent:** Structure the message
...
- **Scope boundary:** No universal word-count or conversion guarantee
- **Final public route:** `/artikel/hierarki-pesan-media-luar-ruang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Hierarki Pesan untuk Media Luar Ruang**.
...
- `OAD-04-A02` → `/artikel/tipografi-ooh-kontras-keterbacaan.html` — Tipografi OOH: Ukuran Relatif, Kontras, dan Keterbacaan
...
- **Tie back to this article:** Keep the explanation specific to “Hierarki Pesan untuk Media Luar Ruang”.
