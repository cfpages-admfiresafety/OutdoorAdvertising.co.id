---
article_id: OAD-05-A03
title: "Papan Nama dan Huruf Timbul: Memilih Sistem Fasad"
slug: "papan-nama-dan-huruf-timbul"
description: "Compare panel signs, channel letters, individual letters, face/halo illumination, backing, attachments, wiring, and maintenance"
status: outline
publication_date: "2025-12-09"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: OAD-05
primary_intent: "Compare facade signage"
reader_community: "Outdooradvertising.co.id"
reader_address: "Teman Outdooradvertising.co.id"
final_route: "/artikel/papan-nama-dan-huruf-timbul.html"
...
# Papan Nama dan Huruf Timbul: Memilih Sistem Fasad

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Papan Nama dan Huruf Timbul: Memilih Sistem Fasad”
- **Reader and situation:** Shop or building owner
- **Reader outcome:** Compare panel signs, channel letters, individual letters, face/halo illumination, backing, attachments, wiring, and maintenance
- **Primary intent:** Compare facade signage
...
- **Scope boundary:** No host-wall capacity or waterproofing approval
- **Final public route:** `/artikel/papan-nama-dan-huruf-timbul.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Papan Nama dan Huruf Timbul: Memilih Sistem Fasad**.
...
- **Exact Markdown to insert:** `![Ilustrasi huruf timbul 1](/wp-content/uploads/2024/05/huruf-timbul-1.png)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `huruf timbul 1` as relevant content media; no pixels were inspected.
...
- `/jasa-pembuatan-papan-nama-di-yalimo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembuatan-papan-nama-di-yahukimo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembuatan-papan-nama-di-wonosobo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembuatan-papan-nama-di-wonogiri` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembuatan-papan-nama-di-way-kanan` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `OAD-05-A01` → `/artikel/baliho-dan-billboard-bedanya.html` — Baliho dan Billboard: Bedanya di Sistem, Bukan Sekadar Nama
- `OAD-05-A02` → `/artikel/totem-dan-pole-sign.html` — Totem dan Pole Sign: Orientasi, Struktur, dan Akses Servis
- `OAD-05-A04` → `/artikel/neon-box-dan-neon-flex.html` — Neon Box dan Neon Flex: Fungsi Berbeda, Risiko Berbeda
- `OAD-05-A05` → `/artikel/branding-mobil-desain-material-pemasangan.html` — Branding Mobil: Desain, Material, Pemasangan, dan Pelepasan
...
- **Tie back to this article:** Keep the explanation specific to “Papan Nama dan Huruf Timbul: Memilih Sistem Fasad”.
