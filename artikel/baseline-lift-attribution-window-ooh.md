---
article_id: OAD-02-A05
title: "Baseline, Lift, dan Attribution Window untuk Kampanye OOH"
slug: "baseline-lift-attribution-window-ooh"
description: "Explain baselines, controls, seasonality, attribution windows, confounders, and cautious interpretation"
status: outline
publication_date: "2025-10-04"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: OAD-02
primary_intent: "Design an evaluation"
reader_community: "Outdooradvertising.co.id"
reader_address: "Teman Outdooradvertising.co.id"
final_route: "/artikel/baseline-lift-attribution-window-ooh.html"
...
# Baseline, Lift, dan Attribution Window untuk Kampanye OOH

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Baseline, Lift, dan Attribution Window untuk Kampanye OOH”
- **Reader and situation:** Analyst comparing before and after
- **Reader outcome:** Explain baselines, controls, seasonality, attribution windows, confounders, and cautious interpretation
- **Primary intent:** Design an evaluation
...
- **Scope boundary:** Does not claim causality from simple correlation
- **Final public route:** `/artikel/baseline-lift-attribution-window-ooh.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Baseline, Lift, dan Attribution Window untuk Kampanye OOH**.
...
- **Tie back to this article:** Keep the explanation specific to “Baseline, Lift, dan Attribution Window untuk Kampanye OOH”.
