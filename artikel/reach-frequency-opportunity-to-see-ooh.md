---
article_id: OAD-02-A02
title: "Reach, Frequency, dan Opportunity to See pada Media Luar Ruang"
slug: "reach-frequency-opportunity-to-see-ooh"
description: "Explain metric meanings, inputs, duplication, assumptions, and why exposure is not attention"
status: outline
publication_date: "2025-09-24"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: OAD-02
primary_intent: "Understand exposure metrics"
reader_community: "Outdooradvertising.co.id"
reader_address: "Sobat Outdooradvertising.co.id"
final_route: "/artikel/reach-frequency-opportunity-to-see-ooh.html"
...
# Reach, Frequency, dan Opportunity to See pada Media Luar Ruang

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Reach, Frequency, dan Opportunity to See pada Media Luar Ruang”
- **Reader and situation:** Buyer evaluating a media proposal
- **Reader outcome:** Explain metric meanings, inputs, duplication, assumptions, and why exposure is not attention
- **Primary intent:** Understand exposure metrics
...
- **Scope boundary:** No audience number without a named audited source and period
- **Final public route:** `/artikel/reach-frequency-opportunity-to-see-ooh.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Reach, Frequency, dan Opportunity to See pada Media Luar Ruang**.
...
- `OAD-02-A01` → `/artikel/tujuan-kampanye-ooh-yang-bisa-diukur.html` — Menyusun Tujuan Kampanye OOH yang Bisa Diukur
- `OAD-02-A03` → `/artikel/exposure-bukan-attention-ooh.html` — Exposure Bukan Attention: Cara Membaca Klaim Viewability OOH
- `OAD-02-A04` → `/artikel/mengukur-respons-langsung-dari-ooh.html` — Mengukur QR, Short URL, Telepon, dan Kunjungan dari OOH
...
- **Tie back to this article:** Keep the explanation specific to “Reach, Frequency, dan Opportunity to See pada Media Luar Ruang”.
